...
//user_pref("general.useragent.override", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:147.0) Gecko/20100101 Firefox/147.0");
...
user_pref("browser.startup.page", 1);//do not re-open previously open tabs
...
user_pref("media.wmf.zero-copy-nv12-textures-force-enabled", true);//remove youtube 4k 60fps AV1 AMD GPU micro-stutter
user_pref("layers.acceleration.disabled", false);//manually force HW accel
user_pref("browser.preferences.defaultPerformanceSettings.enabled", false);//manually force HW accel
...
user_pref("layout.css.scroll-state.enabled", false);//container scroll-state queries
