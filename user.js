...
/* Disable legacy cipher suites, breaks filehosters (with the red M) and websites (Gibson Research Corp)
https://clienttest.ssllabs.com:8443/ssltest/viewMyClient.html */
//user_pref("security.ssl3.ecdhe_ecdsa_aes_128_sha", false);//weak, disabled by Moz in FF137 only
//user_pref("security.ssl3.ecdhe_ecdsa_aes_256_sha", false);//weak, disabled by Moz in FF137 only
...
user_pref("dom.media.webcodecs.h265.enabled", true);//both paid and free win store HEVC codecs won't work
...
// The following settings fix a massive memory leak with AMD drivers, thank for nothing Moz
user_pref("media.gpu-process-decoder", false);//keeps most functionality
//user_pref("media.hardware-video-decoding.enabled", false);//cripples all hw accel
//user_pref("media.hardware-video-decoding.force-enabled", false);//cripples all hw accel
*/
