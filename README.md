...
This behaviour looks way more "human" to a tracking script, rather than fully turning your API off. There is no off switch in the regular settings GUI normal users see, but there is a "deny" button in the pop-up you would normally see.
